...
import shrungar from "../../assets/newImages/shrungar.png"
import shrungarGirl from "../../assets/mobile/saundaryaShrungar/shrungarGirl.svg"
import title from "../../assets/mobile/saundaryaShrungar/title.svg"
const products = [
    { img1:s11 , image: s1 },
    { img1:s12, image: s2 },
    { img1:s13 , image: s3 },
...
const Shrungar = () => {
   ...
   {isMobileView ? (
     ...
     <div
          style={{ backgroundImage: `url(${shrungarGirl})` }}
...
<>
    <div className="">
            <div
              ...
              <img src={shrungar} alt="backgroundImge" className="w-full object-contain h-auto" />
              <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">


                <div className="container pt-10 flex flex-col  items-end">
                    <div className="flex justify-end items-center pb-10 flex-col w-full max-w-[750px]    ">
                        ...
                        <div className="w-full pb-20 flex justify-end items-end   ">
